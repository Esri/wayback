        ...
        return(
            <div className='gutter-container'>
                ...
                <div className='shadow-trailer padding-leader-quarter padding-trailer-quarter trailer-quarter'>
                    <div className='gutter-nav-btn js-modal-toggle' data-modal="about" title='about this app'>
                    ...
                    <div className='gutter-nav-btn js-modal-toggle' data-modal='share' title='share'>
                    ...
                    <div className='gutter-nav-btn js-modal-toggle' data-modal='setting' title='settings'>
