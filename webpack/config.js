const ENV_VARIABLES = [
    ...
    },
    {
        ...
        required: false,
        default:
            'https://servicesdev.arcgis.com/VLx4vrvwONglS8iz/arcgis/rest/services/Vivid_Standard_Blocks_Publication_View/FeatureServer/0',
    },
    {
        name: 'COMMUNITY_UPDATES_FEATURE_LAYER_URL',
        required: false,
        default:
            'https://servicesdev.arcgis.com/VLx4vrvwONglS8iz/arcgis/rest/services/Community_Blocks_Simple_Publication_View/FeatureServer/0',
    },
    {
