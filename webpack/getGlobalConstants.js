...
const getGlobalConstants = (
    ...
    if(!envConfig){
        logErrorAndExit('No environment configuration provided for global constants generation.');
    }
    ...
    return {
        ...
        ENV_WAYBACK_SUBDOMAINS: JSON.stringify(parseSubdomains(envConfig.WAYBACK_SUBDOMAINS)),
